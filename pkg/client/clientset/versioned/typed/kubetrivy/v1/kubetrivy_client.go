...
func NewForConfig(c *rest.Config) (*KubetrivyV1Client, error) {
	config := *c
	...
	return &KubetrivyV1Client{client}, nil
}

// NewForConfigOrDie creates a new KubetrivyV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *KubetrivyV1Client {
...
// New creates a new KubetrivyV1Client for the given RESTClient.
func New(c rest.Interface) *KubetrivyV1Client {
	return &KubetrivyV1Client{c}
}
...
func (c *KubetrivyV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
